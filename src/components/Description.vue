...
<template>
  <div class="description">
    <VanCellGroup class="desc" title="說明">
      <VanCell>
      <div class="disc">
        <p>
    ...
    <VanCellGroup title="開發說明">
      ...
      <div class="disc">
        ...
        <p>
        由於「"澳車北上"信息管理服务系统」API有CORS（跨域源資源共用）限制，此演示有直連或Proxy的設定，假如您的瀏覧器有安裝"Allow CORS"之類的插件，可以使用直連。Proxy版由作者托管的Nignx Reverse Proxy，只作為API請求轉發，如不信任請不要使用Proxy。
        </p>
        <p><a target="_blank" href="https://github.com/oscar-wg/acbs-helper" style="text-decoration: underline">源代碼地址</a></p>
      </div>
      </VanCell>
    </VanCellGroup>
